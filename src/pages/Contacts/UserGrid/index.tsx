...
const UserGrid = () => {
  document.title = "Admission Grid";
  const dispatch = useDispatch();

  const selectLeadData = createSelector(
    (state: any) => state.contacts.users,
    leadsChart => leadsChart
  );
  // Inside your component
  const users = useSelector(selectLeadData);
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Contacts" breadcrumbItem="Admission Funnel" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
